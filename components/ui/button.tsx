  ...
  "inline-flex items-center justify-center whitespace-nowrap rounded-xl text-sm font-bold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 uppercase tracking-wide active:scale-95 duration-200",
  {
    variants: {
      variant: {
        ...
        primary: "bg-sky-400 text-primary-foreground hover:bg-sky-400/90 border-sky-500 border-b-4 active:border-b-0 hover:shadow-[0_0_20px_rgba(56,189,248,0.5)]",
        primaryOutline: "bg-background text-sky-500 hover:bg-muted",
        secondary: "bg-green-500 text-primary-foreground hover:bg-green-500/90 border-green-600 border-b-4 active:border-b-0 hover:shadow-[0_0_20px_rgba(34,197,94,0.5)]",
        secondaryOutline: "bg-background text-green-500 hover:bg-muted",
        ...
        sidebarOutline: "bg-sky-500/15 text-sky-500 border-sky-300 border-2 hover:bg-sky-500/20 transition-all",
